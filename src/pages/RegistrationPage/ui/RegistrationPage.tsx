import { authValidationRules, RegistrationFormData, useRegisterMutation } from "@/features/Authorization";
  ...
  return (
    <>
      ...
      <Form form={form} onFinish={handleSubmit} autoComplete="off">
        <Form.Item name="username" rules={authValidationRules.username} hasFeedback>
        ...
        <Form.Item name="confirmPassword" rules={authValidationRules.confirmPassword} hasFeedback>
          <Input.Password type="password" placeholder="Подтвердите пароль" />
        </Form.Item>
        <Form.Item name="email" rules={authValidationRules.email} hasFeedback>
          <Input type="email" placeholder="Почта" />
        </Form.Item>
        <Form.Item name="phone" rules={authValidationRules.phoneNumber} hasFeedback>
