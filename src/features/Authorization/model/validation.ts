import { RegistrationFormData } from "@/features/Authorization";
import { VALIDATION_MESSAGE } from "@/shared";
import { Rule } from "antd/es/form";
import { MAX_CHARACTERS, MIN_LOGIN_CHARACTERS, MIN_PASSWORD_CHARACTERS, MIN_USERNAME_CHARACTERS } from "./constants";

export const authValidationRules: Record<keyof RegistrationFormData, Rule[]> = {
  username: [
